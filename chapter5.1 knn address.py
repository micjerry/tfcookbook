...
reference_addresses = np.array([x[0] for x in reference_data])
...
for i in range(n):
    ...
    print('Address: {} {}'.format(str(test_address_entry), str(test_zip_)))
    print('Match : {} {}'.format(str(best_street), str(best_zip)))